...
bool move = true, detSheep = false, detWay = false, detLast = false;
...
void input_sheeps()
{
        ...
        for (i = 0; i < 4; i++){
            ...
            {
                Check1:
                /* printf("Input first vertical cordinate of the sheep with %d decks: ",i+1);  gets(_x1); */
                /* printf("\nInput first horisontal cordinate of the sheep with %d decks: ",i+1); */ scanf("%d%d",&x1,&y1);
                if (i > 0)
                /* printf("Input first vertical cordinate of the sheep with %d decks: ",i+1);  gets(_x2);  */
                /* printf("\nInput first horisontal cordinate of the sheep with %d decks: ",i+1); */ scanf("%d%d",&x2,&y2);
                else {x2 = x1; y2 = y1;}
                ...
                if (make_sheep(player1,char_player1,x1,y1,x2,y2,i + 1) == false) { printf("\nIncorrect value! Try again ...\n"); goto Check1; };
                system("cls");
                make_field(player1);
             }
        }
